...
public class ItemStackUtils {
    ...
    private static final fr.maxlego08.menu.zcore.utils.nms.NmsVersion NMS_VERSION = fr.maxlego08.menu.zcore.utils.nms.NmsVersion.nmsVersion;
    ...
    public static String serializeItemStack(ItemStack paramItemStack) {
        ...
        if (fr.maxlego08.spawner.zcore.utils.nms.NmsVersion.getCurrentVersion().isAttributItemStack()) {
    ...
    public static ItemStack deserializeItemStack(String paramString) {
        ...
        try {
            if (fr.maxlego08.menu.zcore.utils.nms.NmsVersion.nmsVersion == fr.maxlego08.menu.zcore.utils.nms.NmsVersion.V_1_20_4) {
            ...
            if (NMS_VERSION == fr.maxlego08.menu.zcore.utils.nms.NmsVersion.V_1_11 || NMS_VERSION == NmsVersion.V_1_12) {
