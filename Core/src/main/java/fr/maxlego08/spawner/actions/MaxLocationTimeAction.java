...
public class MaxLocationTimeAction extends Action {
    private final SpawnerPlugin plugin;
    private final int amount;

    public MaxLocationTimeAction(SpawnerPlugin plugin, int amount) {
        this.plugin = plugin;
        this.amount = amount;
    }
    ...
    protected void execute(Player player, Button button, InventoryEngine inventoryEngine, Placeholders placeholders) {
        ...
        spawner.getOption().addMaxLocationTime(amount);
