package fr.maxlego08.spawner.inventory;

import java.util.HashMap;
import java.util.Map;

import fr.maxlego08.spawner.exceptions.InventoryOpenException;
import fr.maxlego08.spawner.zcore.utils.ZUtils;
import fr.maxlego08.spawner.zcore.utils.inventory.InventoryResult;
import fr.maxlego08.spawner.zcore.utils.inventory.ItemButton;
...
import fr.maxlego08.spawner.zcore.utils.builder.ItemBuilder;

public abstract class VInventory extends ZUtils implements Cloneable {

	protected int id;
	protected SpawnerPlugin plugin;
	...
	protected InventoryResult preOpenInventory(SpawnerPlugin main, Player player, int page, Object... args)
	...
	public abstract InventoryResult openInventory(SpawnerPlugin main, Player player, int page, Object... args)
			throws InventoryOpenException;
	 ...
	 * @param player
	 */
	protected void onClose(InventoryCloseEvent event, SpawnerPlugin plugin, Player player) {
	}
	 ...
	 * @param player
	 */
	protected void onDrag(InventoryDragEvent event, SpawnerPlugin plugin, Player player) {
	}
